...
library(readxl)
estrategia_convivencia <- read_excel("C:/directorio/estrategia_convivencia.xlsx")
View(estrategia_convivencia)
...
#Original En https://cran.r-project.org/web/packages/udpipe/vignettes/udpipe-usecase-postagging-lemmatisation.html 
